...
class CTRBBlock{
	...
	function enqueueBlockAssets(){
		wp_register_style( 'fontAwesome', CTRB_DIR_URL . 'assets/css/font-awesome.min.css', [], '6.4.2' ); // Icon
	}
	...
	function onInit() {
		...
		wp_set_script_translations( 'ctrb-counters-editor-script', 'counters-block', CTRB_DIR_PATH . 'languages' );
	}
	...
	function render( $attributes ){
		...
		wp_set_script_translations( 'ctrb-counters-script', 'counters-block', CTRB_DIR_PATH . 'languages' );
